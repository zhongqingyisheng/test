...
//            }
            ...
            oAuthService.addAccessToken(accessToken, oAuthService.getByAuthCode(authCode));
            //记录用户持有token
            oAuthService.addUserIdToToken(oAuthService.getByAuthCode(authCode).get("userId").toString(),accessToken);
